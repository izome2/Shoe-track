...
const Navbar = () => {
  ...
  return (
    <>
      <motion.header className="fixed top-5 right-5 w-auto h-auto flex items-center justify-center z-[2000] mobile-only">
        <motion.button
          onClick={toggleMenu}
          ...
          >
            ...
            >
              <img
                src={logo}
                alt="logo/img"
                className={`w-28 h-auto mb-4 logo-img ${
              ...
              <motion.button
                ...
                transition={{ type: "spring", stiffness: 300 }}
              >
                Start shopping →<div className="startShoppingGlow"></div>
              </motion.button>
                ...
                <div
                  className={`absolute top-4 right-0 shadow w-4 h-4 text-[0.65rem] leading-tight font-medium rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-all duration-300 ${
                    navActive
                      ...
                      : "bg-slate-100 text-white shadow-slate-100"
                  }`}
                  style={{ color: navActive ? "#FFF" : "#000" }}
                >
                  {totalQTY}
                </div>
              </motion.button>
      ...
      <motion.header
        className={`desktop-nav fixed top-5 left-1/2 transform -translate-x-1/2 w-[80%] h-[6vh] flex items-center justify-center opacity-100 z-[200] ${
          navActive
            ? "blur-effect-theme"
        ...
        style={{
          borderRadius: "20px",
          boxShadow: `${
            navActive ? "0px 2px 8px 0px rgba(0, 0, 0, 0.3)" : "none"
          }`,
          backdropFilter: `${navActive ? "blur(18px)" : "none"}`,
        }}
        animate={{ opacity: 1 }}
        initial={{ opacity: 0 }}
      ...
      >
        <nav className="flex items-center justify-between nike-container">
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <div
              className="startShoppingContainer"
              style={{
                position: "relative",
